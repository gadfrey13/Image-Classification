...
#define MaxIterate   500000 // maximum number of iterations before giving up training
...
#define Activation2    2     // Specify desired activation function for hidden and output layers
...
// data files -----------------------------------------------
#define TrainFile    "medData.dat"  // file containing training data
#define TestFile     "medDataTest.dat"  // file containing testing data 
