...
#define Criteria     0.0001      // all training outputs must be within this for training to stop
#define TestCriteria 0.0002    // all testing outputs must be within this for generalization

#define LearningRate 0.3     // most books suggest 0.3 as a starting point
#define Momentum     0.8    // must be >=0 and <1
...
#define MaxIterate   50000000 // maximum number of iterations before giving up training
...
#define NumNodes2    1      // col 2 - hidden layer 1, etc.//This is the number of outputs
...
#define Activation2  5     // Specify desired activation function for hidden and output layers
#define Activation3  0     // 1=sig, 2=tanh, 3=relu, 4=leakyRelu, 5=linear
#define Activation4  0
#define Activation5  0
#define Activation6  0
#define NumOfCols    2       // number of non-zero layers specified above, including the input layer
#define NumOfRows    4       // largest layer - i.e., max number of rows in the network

// data files -----------------------------------------------
#define TrainFile    "avgData.dat"  // file containing training data
#define TestFile     "avgDataTest.dat"  // file containing testing data
