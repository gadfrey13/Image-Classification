...
#define Criteria     1.0      // all training outputs must be within this for training to stop
#define TestCriteria 1.5    // all testing outputs must be within this for generalization

#define LearningRate 0.1     // most books suggest 0.3 as a starting point
...
#define MaxIterate   4000000 // maximum number of iterations before giving up training
...
#define NumOfRows    6       // largest layer - i.e., max number of rows in the network

// data files -----------------------------------------------
#define TrainFile    "avgmedData.dat"  // file containing training data
#define TestFile     "avgmedDataTest.dat"  // file containing testing data 
